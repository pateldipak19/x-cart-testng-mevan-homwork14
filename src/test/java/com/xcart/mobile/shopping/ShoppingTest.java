...
public class ShoppingTest extends TestBase {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForAvengersFabricationsPlush() throws InterruptedException {
        ...
        Thread.sleep(2000);
        logInAccount.enterEmailId("dipakqa1", "@yahoo.com");
        ...
        Thread.sleep(2000);
        targetCheckout.enterFirstName("Dipak");
        targetCheckout.enterLastName("Patel");
        targetCheckout.enterAddress("88 Bridge Court");
        Thread.sleep(2000);
        targetCheckout.enterCity("San Jose");
        Thread.sleep(2000);
        targetCheckout.selectCountryFromDropDownMenu("United Kingdom");
        targetCheckout.enterState("Harrow");
        Thread.sleep(2000);
        targetCheckout.enterZipCode("0909454");
        Thread.sleep(3000);
        targetCheckout.clickOnCreateAnAccountCheckBox();
        targetCheckout.enterPassword("Aa1234567689");
        Thread.sleep(2000);
